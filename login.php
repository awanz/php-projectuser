  ...
  if (!empty($_SESSION)) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
      ...
      if (mysqli_num_rows($resultData) > 0) {
        $resultData = $resultData->fetch_object();
        $_SESSION['login'] = "masuk";
        $_SESSION['username'] = $username;
        $_SESSION['user_id'] = $resultData->id;
        $_SESSION['level'] = $resultData->level;
    ...
    <section class="login-content">
      ...
      <div class="login-box">
        <form class="login-form" method="POST" action="">
          ...
          <br>
          <div class="form-group">
            <p>No have account? <a href="registration.php">Registration</a> | Back to <a href="index.php">Home</a></p>
          </div>
        </form>
